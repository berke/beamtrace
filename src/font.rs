// Font data extracted from "font173.h", part of HP2xx by Heinz W. Werntges
...
const FONT173 : &[(char,&[u8])] = &[
    ...
    ('∀',b"031264331047307"), // forall 
    ('#',b"044252104312026326030330"), // hash 
    ('∃',b"031271265225067227"), // exists 
    // ('%',b"024332051250270271251066265305306266"), // percent 
    // ('&',b"124230231252271270226225244264326"), // ampersand 
    // ('x',b"031251270267266225067227"), // ni 
    // ('{',b"132270266324"), // opening brace 
    // ('}',b"024266270232"), // closing brace 
    // ('*',b"005351145211072264"), // asterisk 
    // ('+',b"065271027327"), // plus 
    // (',',b"064244245265263242"), // comma 
    // ('-',b"027327"), // minus 
    // ('.',b"064244245265264"), // dot 
    // ('/',b"352"), // slash 

    // ('≡',b"025325027327030251270310331"), // congruent 
    // ('x',b"024231252312331324026326"), // A 
    // ('x',b"024232312331330307227024304325326307"), // B
    // ('Χ',b"024332124232"), // Chi (X) 
    // ('Δ',b"024272324224"), // Delta 
    // ('x',b"124224232332027307"), // E
    // ('ϕ',b"052312072264044304027251311327305245227"), // Phi 
    // ('Γ',b"052332330072264044304"), // Gamma 
    // ('x',b"024232124332027327"), // H
    // ('x',b"024324064272032332"), // I
    // ('ϑ',b"027304330331271270326"), // vartheta 
    // ('x',b"024232027247324047332"), // K
    // ('Λ',b"024272324"), // Lambda 
    // ('x',b"024232270332324"), // M
    // ('x',b"024232324332"), // N
    // ('x',b"044225231252312331325304244"), // O

    // ('Π',b"044252032332112304"), // Pi 
    // ('Θ',b"044225231252312331325304244027327"), // Theta 
    // ('Ρ',b"024232312331330307227"), // Rho (P) 
    // ('Σ',b"044252032332112304"), // Sigma 
    // ('x',b"064272232332"), // T
    // ('x',b"032231266264066331332"), // Y
    // ('ς',b"042262303304225226247307"), // varsigma 
    // ('Ω',b"024244226231252312331326304324"), // Omega 
    // ('Ξ',b"031232332331050246047307110306025224324325"), // Xi 
    // ('Ψ',b"030250246306310330052312072264044304"), // Psi 
    // ('x',b"032332224324"), // Z
    ...
    ('♥',b"030252271312330265230"), // heartsuit 
    ('♠',b"026271326305267245226067264"), // spadesuit 
    ('↔',b"027327106327310046227250"), // leftrightarrow 
    ('←',b"027327046227250"), // leftarrow 
    ('↑',b"072264030272330"), // uparrow 
    ('→',b"027327106327310"), // rightarrow 
    ('↓',b"072264026264326"), // downarrow 

    ('°',b"050251272311310267250"), // degree 
    ('±',b"065271027327025325"), // plusminus 
    ...
    ('≠',b"030330026326045311"), // notequal 
    ('x',b"025325027327031331"), // identity 
    ('≈',b"026247266306327030251270310331"), // approx 
    ('⋯',b"024225064265124325"), // ellipsis 
    // ('x',b"072264"), // center part of braces and brackets 
    // ('x',b"027327"), // horiz line 
    // ('x',b"027327046227250127330"), // leftanglearrow 

    // ('ℵ',b"024245247130307305030324"), // aleph 
    // ('ℑ',b"050231252272330132310305264244225"), // Im 
    // ('ℜ',b"050231252312330307305324107267072265244225"), // Re 
    // ('℘',b"030227245243222224246247270310327325304264245"), // wp 
    // ('⊗',b"027230251311330326305245226227045310050305"), // otimes 
    // ('⊕',b"027230251311330326305245226227071265027327"), // oplus 
    // ('⊘',b"027251311327305245227024332"), // oslash 
    // ('∩',b"025230251311330325"), // cap 
    // ('∪',b"031226245305326331"), // cup 
    // ('x',b"025305326330311231"), // superset 
    // ('x',b"026306327310230024324"), // supsetequal 
    // ('x',b"125245226230251331045311"), // not subset 
    // ('⊂',b"125245226230251331"), // subset 
    // ('⊆',b"126246227250330024324"), // subsetequal 
    // ('∈',b"125245226230251331027327"), // in 
    // ('∉',b"125245226230251331027327045311"), // not in 

    ('∠',b"132224324"), // angle 
    ('∇',b"032332264232"), // nabla 
    ...
    ('∏',b"024231124331031331"), // prod 
    ('√',b"026246264311331"), // root 
    ('·',b"066267"), // centered dot 
    ('¬',b"026326325"), // neg 
    ('∧',b"024267324"), // wedge 
    ('∨',b"030264330"), // vee 
